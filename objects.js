...
for (let i = 0; i < Car.length; i++) {
    ...
    console.log(takePrint1, taketoPrint2, taketoPrint3, taketoPrint4, taketoPrint5, taketoPrint6, taketoPrint7, taketoPrint8, taketoPrint9, taketoPrint10, taketoPrint11, taketoPrint12);
}
